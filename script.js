...
function forecastLocationSearch(coordinates) {
  let apiKey = "ae257b6f200fc59e9f754b38798d7627";
  let apiUrl = `https://api.openweathermap.org/data/2.5/onecall?lat=${coordinates.lat}&lon=${coordinates.lon}&appid=${apiKey}&units=metric`;
  axios.get(apiUrl).then(getForecast);
}
let forecastLocation = document.querySelector("#locationSearch");
forecastLocation.addEventListener("submit", forecastLocationSearch);
